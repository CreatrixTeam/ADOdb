...
class ADODB_ado extends ADOConnection {
	...
	protected  $_affectedRows = false;
	protected  $_thisTransactions;
	protected  $_cursor_type = 3; // 3=adOpenStatic,0=adOpenForwardOnly,1=adOpenKeyset,2=adOpenDynamic
	protected  $_cursor_location = 3; // 2=adUseServer, 3 = adUseClient;
	protected  $_lock_type = -1;
	protected  $_execute_option = -1;
