...
class ADODB_Compress_Bzip2 {
	...
	public function setBlockSize($block_size) {
		//assert($block_size >= 1);	REMOVED FOR PHP5 COMPATIBILTY.	OLD: assert('$block_size >= 1');
		//assert($block_size <= 9);	REMOVED FOR PHP5 COMPATIBILTY.	OLD: assert('$block_size <= 9');
	...
	public function setWorkLevel($work_level) {
		//assert($work_level >= 0);	REMOVED FOR PHP5 COMPATIBILTY.	OLD: assert('$work_level >= 0');
		//assert($work_level <= 250); REMOVED FOR PHP5 COMPATIBILTY.	OLD: assert('$work_level <= 250');
